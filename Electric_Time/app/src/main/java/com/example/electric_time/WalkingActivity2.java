...
public class WalkingActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String message = intent.getStringExtra(WalkingActivity.EXTRA_MESSAGE);
        ...
        textView.setText(walkingVal);
        //Set Boosted Time
        TextView textView2 = findViewById(R.id.textView9);
        textView2.setText(boostedMiniSVal);
