...
public class SegwayNinebotSPlusActivity2 extends AppCompatActivity {
    private Integer inputDist;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_segway_ninebot_s_plus2);

        Intent intent = getIntent();
        String message = intent.getStringExtra(SegwayNinebotSPlusActivity.EXTRA_MESSAGE);
        ...
        textView.setText(segwayNinebotSPlusVal);
        //Set Boosted Time
