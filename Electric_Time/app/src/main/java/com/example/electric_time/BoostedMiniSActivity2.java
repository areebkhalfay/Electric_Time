...
public class BoostedMiniSActivity2 extends AppCompatActivity {
    private Integer inputDist;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_boosted_mini_s2);

        Intent intent = getIntent();
        String message = intent.getStringExtra(BoostedMiniSActivity.EXTRA_MESSAGE);
        ...
        textView.setText(boostedMiniSVal);
        //Set Boosted Time
