...
public class EvolveBambooGTR2in1Activity2 extends AppCompatActivity {
    private Integer inputDist;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_evolve_bamboo_g_t_r2in12);
        Intent intent = getIntent();
        String message = intent.getStringExtra(EvolveBambooGTR2in1Activity.EXTRA_MESSAGE);
        ...
        textView.setText(evolveBambooGTR2in1Val);
        //Set Boosted Time
